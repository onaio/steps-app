...
public class EditParticipantActivityTest extends StepsTestRunner {
    ...
    public void setup(){
        ...
        editParticipantActivity = Robolectric.buildActivity(EditParticipantActivity.class, intent)
                .create()
                .get();
    }
