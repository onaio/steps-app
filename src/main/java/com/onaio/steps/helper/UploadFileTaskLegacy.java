...
public class UploadFileTaskLegacy extends AsyncTask<File, Void, Boolean> {
    private final AppCompatActivity activity;
    private final ExportHandler.OnExportListener onExportListener;

    public UploadFileTaskLegacy(AppCompatActivity activity, ExportHandler.OnExportListener onExportListener) {
