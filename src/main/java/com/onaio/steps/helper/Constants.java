...
//strings passed as parameter to intent
    ...
    public static final String[] EXPORT_FIELDS = new String[]{"Phone Number", "Household Id", "Comments", "Member Id", "Family Surname", "First Name", "Age", "Gender", "Deleted", "Survey Status", "Re Election Count", "Re Election Reasons", "Device ID", "Survey ID", "Non-deleted members", "Unique Device ID", "Date Added"};
