...
public class Constants {
    ...
    public static final String EXPORT_FIELDS = "Household Id, Phone Number, Member Id, Family Surname, First Name, Age, Gender, Deleted, Survey Status, Re Election Count, Re Election Reasons";
