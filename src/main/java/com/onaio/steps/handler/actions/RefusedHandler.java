...
public class RefusedHandler implements IMenuHandler,IMenuPreparer {
    ...
    public RefusedHandler(AppCompatActivity activity, IDoNotTakeSurveyStrategy refusedSurveyStrategy) {
        this(activity, refusedSurveyStrategy, new CustomDialog());
    }

    //Constructor to be used for Testing
    RefusedHandler(AppCompatActivity activity, IDoNotTakeSurveyStrategy refusedSurveyStrategy, CustomDialog dialog) {
