        ...
        householdEligibilitySaveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (eligibilityRadioBtnValue.equalsIgnoreCase(activity.getString(R.string.other))) {
                    otherRadioButtonSpecifyValue = ((EditText) activity.findViewById(R.id.others_specify)).getText().toString();
                } else if (eligibilityRadioBtnValue.equalsIgnoreCase(activity.getString(R.string.consent))) {
                    view.setVisibility(View.GONE);
                    eligibilityQuestions.setVisibility(View.GONE);
                    eligibleMembers.setVisibility(View.VISIBLE);

                }
                // Household household = new HouseholdViewWrapper(activity).getHousehold(R.id.generated_household_id, R.id.household_number, R.id.household_comments,R.id.rGrp_household_eligibility,R.id.others_specify);
                //  household.save(db);
